...
export const de = {
  ...
  auth: {
    ...
    strength: { weak: 'Schwach', ok: 'Okay', good: 'Gut', strong: 'Stark' },
    // Client-side validation
    invalidEmail: 'Bitte gib eine gültige E-Mail-Adresse ein.',
    passwordTooShort: 'Das Passwort muss mindestens 8 Zeichen lang sein.',
    passwordWeak: 'Bitte mische Buchstaben mit Zahlen oder Sonderzeichen.',
    passwordMismatch: 'Die Passwörter stimmen nicht überein.',
    // Registration result
    registerDoneTitle: 'Fast geschafft!',
    registerDoneBody: 'Wir haben dir eine E-Mail geschickt. Bestätige deine Adresse über den Link darin, dann kann es losgehen.',
    registerCheckSpam: 'Keine Mail erhalten? Schau im Spam-Ordner nach.',
    // Login errors (server codes)
    errUnverified: 'Bitte bestätige zuerst deine E-Mail-Adresse. Wir haben dir dazu eine Nachricht geschickt.',
    errInvalidCredentials: 'E-Mail oder Passwort ist falsch.',
    errRateLimited: 'Zu viele Versuche. Bitte warte einen Moment.',
    errGeneric: 'Etwas ist schiefgelaufen. Bitte versuche es erneut.',
    // Forgot
    forgotTitle: 'Passwort zurücksetzen',
    forgotBody: 'Gib deine E-Mail-Adresse ein — wir schicken dir einen Link zum Zurücksetzen.',
    forgotSubmit: 'Link anfordern',
    forgotDone: 'Wenn ein Konto zu dieser Adresse existiert, ist eine E-Mail unterwegs.',
    backToLogin: '← Zurück zur Anmeldung',
    // Verify page
    verifyChecking: 'Wir bestätigen deine E-Mail …',
    verifyFailedTitle: 'Link ungültig',
    verifyFailedBody: 'Dieser Bestätigungslink ist ungültig oder abgelaufen. Registriere dich bitte erneut.',
    // Reset page
    resetTitle: 'Neues Passwort vergeben',
    resetBody: 'Wähle ein neues, sicheres Passwort für dein Konto.',
    resetSubmit: 'Passwort speichern',
    resetDoneTitle: 'Passwort geändert',
    resetDoneBody: 'Dein Passwort wurde geändert. Du kannst dich jetzt anmelden.',
    resetFailedTitle: 'Link ungültig',
    resetFailedBody: 'Der Link ist ungültig oder abgelaufen. Fordere bitte einen neuen an.',
  ...
  landing: {
    ...
    tryHint: 'Küche und Geschmack wählen und live zusehen, wie dein Rezept entsteht — ohne Anmeldung.',
    freeNote: 'Zauberkoch ist kostenlos & Open Source.',
    sourceLink: 'Quellcode auf GitHub',
    tryButton: 'Rezept ausprobieren',
    tryLimit: 'Das anonyme Ausprobieren ist für heute aufgebraucht (begrenzt, damit die KI-Kosten fair bleiben). Melde dich kostenlos an, um weiterzuzaubern.',
  ...
  stream: {
    ...
    unlimitedToday: 'Unbegrenzt — eigener Schlüssel aktiv',
  ...
  profile: {
    ...
    exportAction: 'Alle meine Daten herunterladen',
    exportHint: 'Eine JSON-Datei mit Konto, Rezepten, Einkaufsliste und Wochenplan.',
    exportDone: 'Export heruntergeladen',
    exportFailed: 'Export fehlgeschlagen. Bitte später erneut versuchen.',
    deleteAction: 'Konto löschen',
    deleteTitle: 'Konto wirklich löschen?',
    deleteBody:
      'Dein Konto und alles, was daran hängt, wird sofort und endgültig gelöscht — Rezepte, Favoriten, Notizen, Einkaufsliste, Wochenplan und alle geteilten Links.',
    deleteIrreversible: 'Das lässt sich nicht rückgängig machen.',
    deleteExportFirst: 'Tipp: Lade dir vorher deine Daten herunter.',
    deletePasswordLabel: 'Zur Sicherheit dein Passwort',
    deleteConfirm: 'Endgültig löschen',
    deleteWrongPassword: 'Passwort stimmt nicht.',
    deleteFailed: 'Löschen fehlgeschlagen. Bitte später erneut versuchen.',
    keyTitle: 'Eigener Anthropic-Schlüssel',
    keyIntro:
      'Hinterlege deinen eigenen API-Schlüssel und zaubere ohne Tageslimit — die Kosten laufen dann über dein Anthropic-Konto statt über das Projektbudget.',
    keyPlaceholder: 'sk-ant-…',
    keyLabel: 'API-Schlüssel',
    keySave: 'Schlüssel speichern',
    keyChange: 'Anderen Schlüssel hinterlegen',
    keyRemove: 'Schlüssel entfernen',
    keyActive: (hint: string) => `Aktiv · endet auf ${hint}`,
    keyUnlimited: 'Kein Tageslimit, solange der Schlüssel hinterlegt ist.',
    keySaved: 'Schlüssel gespeichert — ab jetzt unbegrenzt.',
    keyRemoved: 'Schlüssel entfernt.',
    keyInvalid: 'Anthropic akzeptiert diesen Schlüssel nicht. Bitte prüfe ihn in der Console.',
    keyMalformed: 'Das sieht nicht nach einem Anthropic-Schlüssel aus (beginnt mit „sk-ant-“).',
    keyFailed: 'Speichern fehlgeschlagen. Bitte später erneut versuchen.',
    keyChecking: 'Schlüssel wird geprüft …',
    keySecurity:
      'Der Schlüssel wird verschlüsselt gespeichert, nie angezeigt und nie an deinen Browser zurückgegeben. Du kannst ihn jederzeit entfernen.',
    keyGetLink: 'Schlüssel in der Anthropic Console erstellen',
  },
  adult: {
    title: 'Kurze Frage',
  ...
  tips: {
    ...
    print: 'Druckansicht ohne Menüs und Buttons — auch als PDF speicherbar.',
  ...
  colophon: {
    ...
    shareTitle: 'App weiterempfehlen',
    shareBody: 'Link kopieren oder QR zeigen',
    madeWith: 'Mit',
  ...
  shareApp: {
    open: 'App teilen',
    title: 'Zauberkoch teilen',
    intro: 'Kostenlos, ohne Anmeldung ausprobierbar \u2014 einfach weitergeben.',
    copy: 'Link kopieren',
    copyHint: 'In die Zwischenablage',
    copied: 'Link kopiert!',
    copyFailed: 'Kopieren hat nicht geklappt \u2014 Link unten markieren.',
    qr: 'QR-Code zeigen',
    qrHint: 'Zum Abscannen mit der Kamera',
    qrHide: 'QR-Code ausblenden',
    qrAlt: 'QR-Code zu zauberkoch.de',
    qrCaption: 'Kamera drauf halten \u2014 fertig.',
    native: 'Teilen \u2026',
    nativeHint: 'WhatsApp, Mail und mehr',
    linkLabel: 'Link zur App',
    close: 'Schlie\u00dfen',
  },
