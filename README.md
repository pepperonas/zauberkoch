...
cd frontend && npx playwright test       # 33 E2E-Tests (lokal)
```

**647 Unit-/Integrationstests laufen bei jedem Push** als
[GitHub Action](.github/workflows/ci.yml); die **33 Playwright-Tests laufen lokal** (sie
