...
<a href="https://zauberkoch.de">
  <img src="docs/hero.png" alt="Zauberkoch — leuchtender Kochtopf, aus dem Gemüse und grüner Dampf aufsteigen" width="820">
</a>
...
cd frontend && npx playwright test       # 35 E2E-Tests (lokal)
```

**647 Unit-/Integrationstests laufen bei jedem Push** als
[GitHub Action](.github/workflows/ci.yml); die **35 Playwright-Tests laufen lokal** (sie
