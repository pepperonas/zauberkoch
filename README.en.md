...
cd frontend && npx playwright test       # 21 E2E tests (local)
```

**638 unit/integration tests run on every push** via
[GitHub Actions](.github/workflows/ci.yml); the **21 Playwright tests run locally** (they need
